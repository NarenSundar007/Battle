...
function animate() {
  ...
  // Ensure enemy stays within canvas bounds
...
animate()
//Keydown - pressing the key, so this one just takes pressing as count, so just keeps on moving even after lifitng the finger
